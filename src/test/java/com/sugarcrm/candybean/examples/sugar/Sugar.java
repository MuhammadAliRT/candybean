...
//		model = buildModel();
	...
	public void login() throws Exception {
		...
		System.out.println("I came to check1");
	...
	public void clickWelcomeButton() throws CandybeanException
	{
		iface.getWebDriverElement(hooks.get("welcome.button")).click();
	}
	...
	public WebDriverInterface getIface() {
		return iface;
	}
